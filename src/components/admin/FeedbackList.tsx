    ...
    <div className="space-y-6">
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-card shadow rounded-lg p-6">
            <h3 className="text-lg font-medium text-foreground mb-2">Total Feedback</h3>
            <p className="text-3xl font-bold text-indigo-600">{stats.totalCount}</p>
          </div>
          
          <div className="bg-card shadow rounded-lg p-6">
            <h3 className="text-lg font-medium text-foreground mb-2">Average Rating</h3>
          ...
          <div className="bg-card shadow rounded-lg p-6">
            <h3 className="text-lg font-medium text-foreground mb-2">Rating Distribution</h3>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="p-2 border border-[var(--border-strong)] rounded-md disabled:opacity-50 disabled:cursor-not-allowed hover:bg-background"
                >
